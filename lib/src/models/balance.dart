class Balance {
  ...
  factory Balance.fromJSON(Map<String, dynamic> json) {
    ...
    return Balance(
        ...
        json['montantEstime'],
        DateTime.parse(
            '${estimatedAmountMsg.substring(18, estimatedAmountMsg.length).split('/').reversed.join('-')}T12:00:00'));
  }

  Balance(this.id, this.hostId, this.label, this.amount,
      this.estimatedHostAmount, this.estimatedAmountDate);
}
